sap.ui.define([
	...
	"Vivo/model/formatter"
], function (Controller, formatter) {
	"use strict";

	return Controller.extend("Vivo.controller.ThingPage", {
		formatter: formatter,
		onInit: function () {
		...
		_readDetailsService: function (oDetailsModel, sThingId) {
			...
			oDetailsModel.read("/Things('" + sThingId + "')", {
				urlParameters: {
					"$expand": "DYN_ENT_dapt_ox181026100231_vivotanks__Image,DYN_ENT_dapt_ox181026100231_vivotanks__Bheki_Dip_Reading"
				},
